...
export function Edit() {
  ...
  const [curQuestionId, setCurQuestionId] = useState<number>(); // 当前选中的题目
  ...
  // react-dnd 底层使用 HTML5 的 drag and drop API，因此额外引入的 html5-backend
  // drag 用于拖区域，drap 用于放区域, isOver 是否正在拖拽
  const [{ isOver }, drop] = useDrop(() => ({
    accept: ["radio", "checkbox", "input"], // 接受类型
    ...
    <div id="edit-container">
      ...
      <div className="body">
        ...
        <div className="materials">
          <MaterialItem name="单选题" type="radio" />
          <MaterialItem name="多选题" type="checkbox" />
          <MaterialItem name="填空题" type="input" />
        </div>
        {/* 拖拽存放区 */}
        <div
          className="edit-area"
